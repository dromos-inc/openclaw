...
export type GatewayRequestContextParams = {
  ...
  getSessionMessageSubscriptionKeys: GatewayRequestContext["getSessionMessageSubscriptionKeys"];
...
export function createGatewayRequestContext(
  ...
  return {
    ...
    getSessionMessageSubscriptionKeys: params.getSessionMessageSubscriptionKeys,
