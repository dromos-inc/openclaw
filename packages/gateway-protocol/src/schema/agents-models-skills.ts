      ...
      Type.Object(
        {
          ...
          outputFormat: Type.Optional(NonEmptyString),
          responseFormat: Type.Optional(NonEmptyString),
          speakerVoice: Type.Optional(NonEmptyString),
          speakerVoiceId: Type.Optional(NonEmptyString),
          speed: Type.Optional(Type.Number()),
          stability: Type.Optional(Type.Number()),
          similarity: Type.Optional(Type.Number()),
          similarityBoost: Type.Optional(Type.Number()),
          style: Type.Optional(Type.Number()),
          speakerBoost: Type.Optional(Type.Boolean()),
          useSpeakerBoost: Type.Optional(Type.Boolean()),
          voice: Type.Optional(NonEmptyString),
          voiceId: Type.Optional(NonEmptyString),
          latencyTier: Type.Optional(Type.Number()),
          language: Type.Optional(NonEmptyString),
          languageCode: Type.Optional(NonEmptyString),
          normalize: Type.Optional(NonEmptyString),
          applyTextNormalization: Type.Optional(NonEmptyString),
        },
        { additionalProperties: false },
      ),
    ),
